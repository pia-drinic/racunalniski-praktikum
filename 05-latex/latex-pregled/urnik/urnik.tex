...
omejitve so bile kršene ter kolikokrat se kršitev pojavi. S $\text{\emph{k}}_n$ označimo število
kršitev omejitve \emph{n}, z $\text{\emph{u}}_n$ pa njeno utež. Z naslednjo formulo izračunamo
kakovost urnika:
\begin{center}
   \[k_1\cdot u_1+k_2\]
...
% TUUUUUU SMOOOOOO OSTALIIIIIIIIII
%
%
%
%
